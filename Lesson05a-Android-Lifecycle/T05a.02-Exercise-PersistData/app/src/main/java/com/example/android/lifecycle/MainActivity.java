...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String textFromLifecycleDisplayTextView = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, textFromLifecycleDisplayTextView);
    }
    /**
