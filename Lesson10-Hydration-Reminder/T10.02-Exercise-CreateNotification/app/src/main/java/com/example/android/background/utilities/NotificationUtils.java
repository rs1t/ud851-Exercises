...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_PENDING_ID = 5431;
    private static final int WATER_REMINDER_NOTIFICATION_ID = 5432;
    ...
    public static void remindUserBecauseCharging(Context context) {
        // DONE (8) In the remindUser method use NotificationCompat.Builder to create a notification
        // that:
