...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mUrlDisplayTextView.setText(savedInstanceState.getString(SEARCH_QUERY_URL));
            mSearchResultsTextView.setText(savedInstanceState.getString(SEARCH_RESULTS_JSON));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String urlFromTextView = mUrlDisplayTextView.getText().toString();
        outState.putString(SEARCH_QUERY_URL, urlFromTextView);
        ...
        String jsonResultsFromTextView = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RESULTS_JSON, jsonResultsFromTextView);
